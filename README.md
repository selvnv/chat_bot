...
- [ ] Сохранение истории сообщений при превышении лимита сообщений (например, 10)
- [ ] Генерация контекста каждые N сообщений (например, 2)
- [ ] Модификация (дополнение) существующего контекста
- [ ] Интерактивный режим для работы с пользователем
  - [ ] Ввод имени пользователя с проверкой на уникальность и настройки хранения истории сообщений
  - [ ] Запрос и вывод ответа в CLI
- [ ] Пропуск сохранения истории сообщений, если в настройках пользователя False
